...
if __name__=="__main__":
    ...
    parser.add_argument('--n_syn', default = 500, type=int)
    ...
    for m in Models:
        for e in epsilons:
            ...
            FBA_model = FBA(name, n_target=n_target, threshold=threshold, latent_dim=latent_dim)

            FBA_model.attack(generator, data, n_syn)
            
            with open("privacy_models/FBA/{}.pickle".format(FBA_model.name_),"wb") as fw:
                pickle.dump(FBA_model, fw)
