...
if __name__=="__main__":
    ...
    for m in Models:
        for e in epsilons:
            ...
            PBA_model = PBA(name, n_target=n_target,threshold=threshold, latent_dim=latent_dim)

            PBA_model.attack(generator=generator, data=data, max_iterations=max_iterations)
            
            with open("privacy_models/PBA/{}.pickle".format(PBA_model.name_),"wb") as fw:
                pickle.dump(PBA_model, fw)
